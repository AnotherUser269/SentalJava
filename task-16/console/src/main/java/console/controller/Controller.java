...
public class Controller {
    ...
    public void run() throws IOException {
        ...
        String url = "jdbc:postgresql://localhost:5432/task11";
        ...
        try {
            saveManager = (SaveManager) context.getBean("saveBean");
            loadManager = (LoadManager) context.getBean("loadBean");

            sqlLoader = new JPALoader(bookDAO, orderDAO, requestDAO);
            sqlSaver = new JPASaver(bookDAO, orderDAO, requestDAO);
        } catch (Exception e) {
