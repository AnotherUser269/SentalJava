...
public class MainMenuScreen implements IScreen<Integer> {
    ...
    final String[] options = {"Add book", "Remove book\n", "Make request", "Cancel request\n",
            ...
            "Show order archive\n", "Save book archive", "Save request archive", "Save order archive",
            "Save book catalog", "Save request catalog", "Save order catalog\n",
            "Load book archive", "Load request archive", "Load order archive",
            "Load book catalog", "Load request catalog", "Load order catalog\n", "Quit"};
